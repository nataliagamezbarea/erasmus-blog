<?php include __DIR__ . '/../../../../backend/obtener_estadisticas.php'; 
?>
    ...
    <div class="col-xl-3 col-xxl-3 col-sm-6">
        <div class="card bg-warning invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 id="numero_publicaciones" class="text-white invoice-num"><?= $totalPublicaciones ?></h2>
                    <span class="text-white fs-18">Publicaciones totales</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-xxl-3 col-sm-6">
        <div class="card bg-success invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 id="max_likes" class="text-white invoice-num"><?= $totalLikes ?></h2>
    ...
    <div class="col-xl-3 col-xxl-3 col-sm-6">
        <div class="card bg-info invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 id="numero_paises" class="text-white invoice-num"><?= $totalPaises ?></h2>
                    <span class="text-white fs-18">Países totales</span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-xxl-3 col-sm-6">
        <div class="card bg-secondary invoice-card">
            <div class="card-body d-flex">
                ...
                <div>
                    <h2 id="usuario_mas_publicaciones" class="text-white invoice-num">Usuario más activo</h2>
                    <span class="text-white fs-18"><?= $usuarioMasPublicaciones ?></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-xl-3 col-xxl-5">
        <div class="card">
            <h4 class="card-title mb-2 top">Top 5 Países con más Usuarios</h4>
            <div class="card-body">
                <?php foreach ($topPaises as $index => $pais):
                    $gradient = "bg-gradient-" . ($index + 1); ?>
                    <div class="progress default-progress mt-4">
                        <div class="progress-bar <?= $gradient ?> progress-animated" style="width: <?= $pais["porcentaje"] ?>%; height:20px;" role="progressbar">
                            <span class="text-white px-2"><?= $pais["cantidad"] ?> usuarios</span>
                        </div>
                    </div>
                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                        <span id="pais<?= $index + 1 ?>"><?= $pais["pais"] ?></span>
                        <span class="fs-18" id="porcentaje<?= $index + 1 ?>"><?= $pais["porcentaje"] ?>%</span>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <div class="col-xl-6 col-xxl-7">
        <div class="card">
            <div class="card-header d-flex justify-content-center border-0 pb-2">
                <h4 class="card-title mb-0 text-center">Publicaciones</h4>
            </div>
            <div class="card-body d-flex justify-content-center align-items-end" style="height: 37vh;">
                <div class="d-flex justify-content-between align-items-end" style="width: 80%; height: 100%; gap: 15px;">
                    ...
                    $maxEscala = 10; // Escala máxima fija
                    $alturaMax = 37; // Altura máxima en vh
                    $gradientes = [
                    ...
                    foreach ($diasSemana as $dia => $cantidad):
                        $alturaVh = ($cantidad / $maxEscala) * $alturaMax;
                        if ($alturaVh > $alturaMax) {
                            $alturaVh = $alturaMax;
                        }
                        $color = $gradientes[$i % count($gradientes)];
                    ?>
                        <div class="text-center d-flex flex-column justify-content-end" style="flex:1;">
                            <div style="background: <?= $color ?>; width:100%; min-height:5px; height:<?= $alturaVh ?>vh; border-radius:10px; transition: height 0.3s;"></div>
    ...
    <div class="col-xl-3 col-xxl-3">
        <div class="card">
            <div class="card-header d-flex justify-content-center border-0 pb-2">
                <h4 class="card-title mb-0 text-center">Últimas Publicaciones</h4>
            </div>
            <div class="card-body">
                <?php
